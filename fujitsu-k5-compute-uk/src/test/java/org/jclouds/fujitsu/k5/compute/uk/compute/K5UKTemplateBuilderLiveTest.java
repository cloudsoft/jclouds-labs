...
@Test(groups = "live", singleThreaded = true, testName = "K5UKTemplateBuilderLiveTest")
public class K5UKTemplateBuilderLiveTest extends BaseTemplateBuilderLiveTest {

   public K5UKTemplateBuilderLiveTest() {
